function [Y_f_BMA,lambda] = BVAR_MINN(Y,p,constant,h,ndraws,lgrid,delta,stdata)
...
disp('Now running BVAR_MINNESOTA')
...
iRW = delta*ones(1,M);   % prior means (0 for stationary, 1 for RW variables)    
